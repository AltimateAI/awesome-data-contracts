...
- [Agentsor File Contracts](https://github.com/linkoinsight/agentsor-file) - An MIT-licensed Python CLI that checks completed local CSV and Parquet files against explicit schema, freshness, row, and byte contracts, with optional redacted receipts for rolling missed-run alerts.
